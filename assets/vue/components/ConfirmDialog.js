                    ...
                    <div
                        ...
                        <Transition
                            ...
                            <div
                                ...
                                <!-- Actions -->
                                <div class="bg-gray-50 px-4 py-3 flex flex-row-reverse gap-2 sm:px-6">
                                    <button
                                        ref="confirmButtonRef"
                                        type="button"
                                        @click="confirm"
                                        :class="['inline-flex justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-2', typeStyles.button]">
                                        {{ options.confirmText }}
                                    </button>
                                    <button
                                        type="button"
                                        @click="cancel"
                                        class="inline-flex justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                                        {{ options.cancelText }}
                                    </button>
                                </div>
                            </div>
